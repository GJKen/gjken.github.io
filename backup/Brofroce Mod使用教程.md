...
# 安装
首先下载下面链接的这4个文件:
1. [UnityModManager](https://www.nexusmods.com/site/mods/21)
2. [Utility Mod](https://www.nexusmods.com/broforce/mods/2)
3. [BroMaker](https://www.nexusmods.com/broforce/mods/13)
4. [RocketLib](https://www.nexusmods.com/broforce/mods/9)

## 安装UnityModManager

下载需要注册账号, 然后选择免费的慢速下载就行.

![](https://github.com/user-attachments/assets/52866ed7-65ec-43c8-b64e-9e27c2aa6113)

UnityModManager 下载完成后可随意放在自己喜欢的地方并运行它.

接着按图中所示下拉找到 Broforce, 没问题后然后点击 install.
